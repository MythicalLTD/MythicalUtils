...
import me.mythicalsystems.mcpanelxcore.api.Console;
import me.mythicalsystems.mcpanelxcore.api.Index;
import me.mythicalsystems.mcpanelxcore.api.Power;
...
public class WebServer extends NanoHTTPD {
    ...
    public static boolean verifyKey(IHTTPSession session) {
        try {
            ...
            Bukkit.getLogger().info("[McPanelX-Core] Authentication error: " + e);
            return false;
        }
    }
