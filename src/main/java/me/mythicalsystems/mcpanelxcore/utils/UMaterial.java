...
public enum UMaterial {
            ...
            if (ce.size() == 0) {
                ...
                final String a = t != null ? t.getName() : null,
                        type = a != null ? a.equals("SPEED") ? "SWIFTNESS"
                                ...
                                : null;
                if (type != null) {
                    final String g = base + type + (max != 1 && l <= max ? "_" + l : "")
                            + (extended ? "_EXTENDED" : "");
                    return valueOf(g);
                }
            }
    ...
    public static UMaterial getItem(Block block) {
        ...
        if (!v.contains("1.8") && !v.contains("1.9") && !v.contains("1.10") && !v.contains("1.11")
                ...
                || m.contains("FENCE_GATE") || m.contains("TRAPDOOR") || m.contains("CHEST")
                || m.equals("DISPENSER") || m.equals("DROPPER") || m.equals("JACK_O_LANTERN") || m.equals("PUMPKIN")
                || m.equals("HAY_BLOCK") || m.contains("SHULKER_BOX") || m.equals("LEVER") || m.contains("BUTTON")
                || m.contains("RAIL") || m.equals("FURNACE") || m.equals("VINE") || m.equals("TRIPWIRE_HOOK")
                || m.equals("HOPPER") || m.equals("END_ROD")) {
            return match(m);
    ...
    public UPotion(UMaterial.PotionBase base, String type, boolean extended, boolean upgraded) {
        ...
        final PotionType t = eight
                ...
                || (eight || nine || ten || eleven || twelve)
                        && (type.equals("TURTLE_MASTER") || type.equals("SLOW_FALLING"))
                                ? PotionType.WATER
