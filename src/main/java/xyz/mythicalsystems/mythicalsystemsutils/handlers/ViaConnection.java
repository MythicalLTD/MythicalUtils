...
public class ViaConnection implements Connection {
    ...
    public ProtocolVersion getProtocol(Player player) {
        ...
        if (api != null) {
            ...
            protocol.name = com.viaversion.viaversion.api.protocol.version.ProtocolVersion.getProtocol(protocol.id)
                    .getName();
        }
    ...
    public List<ProtocolVersion> getSupportedProtocols() {
        ...
        if (api != null) {
            ...
            for (Integer id : ids) {
                versions.add(new ProtocolVersion(id,
                        com.viaversion.viaversion.api.protocol.version.ProtocolVersion.getProtocol(id).getName()));
            }
        }
